    ...
    <Panel id={id}>
        ...
        <ul>
            ...
            <p>
                ...
                <li>
                    Объясняющий не может никаким образом подсказывать буквы и слоги загаданного слова.
                </li>
            </p>
            <li> 
                При объяснении слова нельзя просить пользоваться его переводами.
            </li>
        </ul>
    </Panel>
